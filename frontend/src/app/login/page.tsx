    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
            ...
            <div className="glass-card fade-in" style={{ width: '100%', maxWidth: 420, padding: '40px 36px', zIndex: 1 }}>
                ...
                <h1 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: 6, textAlign: 'center' }}>Welcome back</h1>
                <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.875rem', textAlign: 'center', marginBottom: 28 }}>Sign in to your account</p>
                ...
                <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    <div>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <input className="input-field" type={showPw ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" required style={{ paddingLeft: 40, paddingRight: 40 }} />
                    ...
                    <button type="submit" className="btn-primary" disabled={loading} style={{ justifyContent: 'center', padding: '13px' }}>
                        {loading ? <span className="dot-spinner"><span /><span /><span /></span> : 'Sign In'}
                    </button>
                </form>

                <p style={{ marginTop: 24, textAlign: 'center', fontSize: '0.875rem', color: 'rgba(255,255,255,0.4)' }}>
                    Don't have an account?{' '}
                    <Link href="/signup" style={{ color: '#c4b5fd', fontWeight: 600, textDecoration: 'none' }}>Sign up free</Link>
                </p>
            </div>
        </div>
    );
